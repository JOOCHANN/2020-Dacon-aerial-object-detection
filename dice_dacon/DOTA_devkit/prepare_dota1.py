...
wordname_15 = ['container', 'oil_tanker', 'aircraft_carrier', 'maritime_vessels']



def parse_args():
    parser = argparse.ArgumentParser(description='prepare dota1')
    parser.add_argument('--srcpath', default='/data/hdd/Dacon/dota')
    parser.add_argument('--dstpath', default='/data/hdd/Dacon/dacon_800_300_0.7',
                        help='prepare data')
